...
<table width=400>
  <tr>
    ...
    <td>
      <button id="runButton" class="primary" title="${BlocklyGames.getMsg(
        "Maze.runTooltip",
        true
      )}">
        <img src="common/1x1.gif" class="run icon21"> ${BlocklyGames.getMsg(
          "Games.runProgram",
          true
        )}
      </button>
      <button id="resetButton" class="primary" style="display: none" title="${BlocklyGames.getMsg(
        "Maze.resetTooltip",
        true
      )}">
